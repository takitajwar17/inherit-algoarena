          ...
          <div className="max-w-7xl mx-auto flex justify-between items-center px-4 sm:px-8 py-4">
            ...
            <div className="hidden md:flex space-x-6 items-center">
              ...
              <Link href={isSignedIn ? "/dashboard" : "/sign-in"}>
                <button className="bg-gray-600 text-white px-6 py-2 rounded-full text-lg font-semibold hover:bg-indigo-700 transition-colors">
                  Get Started
                </button>
              </Link>
            </div>
            ...
            <div className="md:hidden bg-white shadow-md">
              <div className="flex flex-col space-y-4 px-4 py-6">
                ...
                <Link
                  ...
                  onClick={() => setIsMenuOpen(false)}
                >
                  <button className="bg-gray-600 text-white px-6 py-2 rounded-full text-lg font-semibold hover:bg-indigo-700 transition-colors w-full">
                    Get Started
                  </button>
                </Link>
              </div>
